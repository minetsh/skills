...
- 赞赏引导图：GIF 或 PNG，750×560，≤500KB，1 张；风格须与表情一致，不能出现与表情不相关的内容；色调活泼明朗，背景须与微信底色有较大区分；图中元素不能因拉伸或压扁而变形；避免使用透明背景。
- 赞赏致谢图：GIF 或 PNG，750×750，≤500KB，1 张；要求同引导图；精心创作的致谢图能激发用户分享意愿、吸引更多用户发赞赏。
